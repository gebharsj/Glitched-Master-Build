...
public class Pickupable : MonoBehaviour 
{
	...
	public Transform pickupablePosition;
	float distance;
    ...
    void pickup()
	{
		if(Input.GetKey(KeyCode.Mouse0)) //Left mouse button is used to pick up the object
        {
			...
			{	
				...
				{
					 // sets the object as a child of the player
					...
					if (p != null) 
					{
						...
						carriedObject = p.gameObject; // does not effect it from not working in fact this  makes it work
